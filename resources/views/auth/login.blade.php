        ...
        <div class="col-lg-6 col-md-10">
          <div class="card">
            ...
            <div class="card-body p-5">
              <h4 class="text-dark mb-5">ingresar</h4>
              
              <form method="POST" action="{{ route('login') }}">
                @csrf
                <div class="row">
                  <div class="form-group col-md-12 mb-4">
                    <input type="email"  name="email" class="form-control input-lg"  aria-describedby="emailHelp" placeholder="ingrese Email">
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="d-flex my-2 justify-content-between">
                      ...
                      <p><a class="text-blue" href="{{ route('password.request') }}">olvidaste tu contraseña?</a></p>
                    </div>

                    <button type="submit" class="btn btn-lg btn-primary btn-block mb-4">ingresar</button>

                    <p>no tines tienes cuenta todavia ?
