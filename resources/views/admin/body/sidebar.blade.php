    ...
    <div id="sidebar" class="sidebar sidebar-with-footer">
      ...
      <div class="app-brand">
        <a href="/index.html" title="Sleek Dashboard">
          ...
          <span class="brand-name text-truncate">administrador</span>
        </a>
      </div>
        ...
        <ul class="nav sidebar-inner" id="sidebar-menu">
          ...
          <li class="has-sub ">
            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#app"
              ...
              <span class="nav-text">CONTACTO PAGINA</span> <b class="caret"></b>
            </a>
              ...
              <div class="sub-menu">
                <li class="">
                  <a class="sidenav-item-link" href="{{route('admin.contact')}}">
                    <span class="nav-text">CONTACTO DEL PERFIL</span>
                  </a>
                </li>

                <li class="">
                  <a class="sidenav-item-link" href="{{route('admin.message')}}">
                    <span class="nav-text">MENSAJE DEL CONTACTO</span>
                  </a>
                </li>
